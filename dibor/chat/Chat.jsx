...
function Chat({ socket, setToken, token }) {
  ...
  const activeUserChat = contacts.find((chat) => chat.id === activeChatId) || {
  ...
  useEffect(() => {
    setFilteredUsers(
      contacts.filter((chat) =>
        chat.user.displayName.toLowerCase().startsWith(query.toLowerCase())
      )
    );
  }, [query]);
          ...
          <div className="row top-bar">
            ...
            <div className="col-8 ">
              <TopBar
                ...
                totalFoundMessages={totalFoundMessages}
